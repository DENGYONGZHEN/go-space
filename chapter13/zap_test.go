...
// {"level":"debug","name":"example","caller":"chapter13/main.go:40","msg":"test debug message","version":"go1.25.2"}
// {"level":"info","name":"example","caller":"chapter13/main.go:41","msg":"test info message","version":"go1.25.2"}
