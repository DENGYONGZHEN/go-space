...
import (
	...
	"github.com/deng/go-space/networkProgrammingWithGo/chapter13/instrumentation/metrics"
...
func main() {
	...
	fmt.Printf("Spawning %d connection to make %d requests each ...", clients, gets)
	for i := 0; i < clients; i++ {
		wg.Add(1)
		go func() {
			defer wg.Done()
